        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "site",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="device.site"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="devices", to="device.port"
                    ),
                ),
                (
                    "device_status",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="device.status"
                    ),
                ),
                (
                    "device_type",
